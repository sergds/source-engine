...
CCrossbowBolt *CCrossbowBolt::BoltCreate( const Vector &vecOrigin, const QAngle &angAngles, int iDamage, CBasePlayer *pentOwner )
{
	...
	UTIL_ScreenShake(vecOrigin, 50.0f, 10, 0.4f, 1000.0f, SHAKE_START);
...
//			NDebugOverlay::Box( GetAbsOrigin(), Vector( -16, -16, -16 ), Vector( 16, 16, 16 ), 0, 0, 255, 0, 10 );
	...
	{
		const QAngle zero(0,0,0);
		ExplosionCreate(GetAbsOrigin(), zero, this, 1000, 500.0f, true, 1000);
		UTIL_ScreenShake(GetAbsOrigin(), 100.0f, 10, 1.0f, 1000.0f, SHAKE_START);
