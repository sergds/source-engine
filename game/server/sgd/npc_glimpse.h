 ...
 * SCP Glimpse nextbot
 */
class CGlimpseBot : public NextBotCombatCharacter
{
public:
	DECLARE_CLASS( CGlimpseBot, NextBotCombatCharacter );
	...
	// INextBot
	DECLARE_INTENTION_INTERFACE( CGlimpseBot )
...
{
public:
	CSimpleBotPathCost( CGlimpseBot *me )
	{
		m_me = me;
	}
