...
// FIXME: Again, our past-gen tier1 is lame and is missing that. Our VScript will be missing KeyValues functionality until a csgo tier1 will be ported.
...
// FIXME: As stated in previous fixme, we need a newer gen tier1 for script KVs.
/*
