...
// FIXME: Uncomment when nextgen tier1 is ported, or kv support gets backported (more likely)
/*
...
// sergds - S2013 doesn't have that
/*
	...
	if( scriptmanager != NULL )
	{
		...
		if( scriptLanguage != SL_NONE )
		{
			...
			if( g_pScriptVM )
			{
				...
				//ScriptRegisterFunction( g_pScriptVM, LoopSinglePlayerMaps, "Run the single player maps in a continuous loop."); // doesn't exist here
